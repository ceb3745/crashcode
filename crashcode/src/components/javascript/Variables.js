        ...
        return(
            <div className="contentPage">
                ...
                <div className="container">
                    <div className="info">
                        <p>In javascript <span className="keyword"> variables </span> are containers for storing any data value. If you want
                           to store a number or phrase for use later you can create a variable using the
                           keyword <span className="keyword"> var </span>. A keyword is a word reserved by the language to have a specific
                        ...
                        <p><span className="keyword"> String: </span> A string of characters, like a word or sentence.</p>
                        ...
                        <p>There is another keyword used to define variables in javascript. This keyword is the
                            <span className="keyword"> const </span> keyword. When you use the const keyword the initial value cannot be changed.</p>
                        ...
                        <p> When naming a variable, the name should represent what the use of that variable is (numberOfClothes, catNames, etc). This way,
                           ...
                           called <span className="keyword"> camelcase </span>. This means that the first word in your variable name will be lowercase, and the following words
                        ...
                        <p>Finally, throughout these examples you may have noticed the use of a <span className="keyword"> semicolon, ";" </span>, after each line of code. The semicolon is what
